    ...
    <body>
        ...
        <section id="prodetails" class="section-p1">
            <div class="single-pro-image">
                <img src="featuredpics/coppergold.jpg" width="100%" id="MainImg" alt="">

            </div>

            <div class="single-pro-image">
                <h6>Home / Copper Gold</h6>
                <h4>Copper Gold Plated Necklace</h4>
                <h2>$79.50</h2>
                <select>
                    <option>Gold</option>
        ...
        <footer class="section-p1">
            <div class="col">
                <img class="logo" src="img/logof.jpg" alt="">
                <h4>Contact</h4>
